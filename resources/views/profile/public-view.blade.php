...
@section('content')
            ...
            @else
                ...
                >
                    <div class="card">
                        ...
                        <div class="px-3 pb-2">
                            <div id="colWrap-{{ $widget['random_id'] }}" class="col-selector-wrap" style="border:1px solid #ddd;border-radius:6px;padding:10px; {{ $isOwner ? '' : 'display:none;' }}">
    ...
    <script>
		document.addEventListener("DOMContentLoaded", function () {
			...
			function isLocked() {
                // Non-owners are always locked, even if the owner's browser has it unlocked.
			...
			function disableDragging() {
                if (widgets.data("ui-draggable")) {
				    widgets.draggable("disable");
                }
                if (widgets.data("ui-resizable")) {
